...
let semesters = [
	{
		...
		courses: [
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Ηλεκτρονική Φυσική,Hlektronikh Fysikh,Hlektronikh Fusikh",
			},
			{
				name: "Φυσική",
				key: "fysikh",
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Εισαγωγή στα Συστήματα Υπολογιστών,Eisagwgh sta Systhmata Ypologistwn",
			}
		]
	},
	{
		...
		courses: [
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Αρχιτεκτονική Υπολογιστών Ι,Arxitektonikh Ypologistwn I",
			},
			{
		...
		courses: [
			{
				...
				searchStr: "ΠΠΣPPS,Αρχιτεκτονική Υπολογιστών ΙΙ,Arxitektonikh Ypologistwn ΙΙ",
			},
			{
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Αγγλική Ορολογία Πληροφορικής,Agglikh Orologia Plhroforikhs",
			},
			{
	...
	},
	{
		...
		courses: [
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Γραμμικά Συστήματα - Γραμμικοί Μετασχηματισμοί,Grammika Systhmata - Grammikoi Metasxhmatismoi",
			},
			{
	...
	},
	{
		...
		courses: [
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Μικροεπεξεργαστές - Μικροελεγκτές,Mikroepeksergastes - Mikroelegktes",
			},
			{
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Ψηφιακή Επεξεργασία Σήματος,Pshfiakh Epeksergasia Shmatos",
			},
			{
			...
			},
			{
				...
				searchStr: "ΝΠΣNPS,Θεωρία Πληροφορίας και Κώδικες,Thewria Plhroforias kai Kwdikes",
			},
			{
			...
			},
			{
				...
				searchStr: "ΝΠΣNPS,Προγραμματισμός σε Συμβολική Γλώσσα,Programmatismos se Symvolikh Glwssa",
			},
			{
				name: "Ανάπτυξη Ψηφιακών Συστημάτων",
				key: "anaptykshPshfiakwnSysthmatwn",
				searchStr: "ΝΠΣNPS,Ανάπτυξη Ψηφιακών Συστημάτων,Anaptyksh Pshfiakwn Systhmatwn",
			},
			{
				name: "Προχωρημένα Θέματα Αντ/φούς Προγραμματισμού",
				key: "proxwrhmenaThemataAntikeimProgr",
				searchStr: "ΝΠΣNPS,,Προχωρημένα Θέματα Αντικειμενοστρεφούς Προγραμματισμού,Proxwrhmena Themata Antikeimenostrefoys Programmatismoy",
			},
			{
	...
	},
	{
		...
		courses: [
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Ασφάλεια και προστασία Δεδομένων,Asfaleia kai prostasia Dedomenwn",
			},
			{
			...
			},
			{
				...
				searchStr: "ΠΠΣPPS,Συστήματα Αυτόματου Ελέγχου,Systhmata Aftomatou Elenxou",
			},
			{
				name: "Αυτόματα και Τυπικές Γλώσσες",
				key: "AutomataKaiTypikesGlwsses",
				searchStr: "ΠΠΣPPS,Αυτόματα και Τυπικές Γλώσσες,Automata,Aftomata kai Typikes Glwsses",
			},
			{
				name: "Ολοκληρωμένα Κυκλώματα",
				key: "OloklhrwmenaKyklwmataMegalhsKlimakas",
				searchStr: "ΠΠΣPPS,Ολοκληρωμένα Κυκλώματα Μεγάλης Κλίμακας,Oloklhrwmena Kyklwmata Megalhs Klimakas",
			},
			{
			...
			},
			{
				...
				searchStr: "ΝΠΣNPS,Διαδικτυακός Προγραμματισμός,Diadiktyakos Programmatismos",
			},
			{
				name: "Αλγοριθμικά Θέματα Δικτύων",
				key: "algorithmikaThemataDiktywn",
				searchStr: "ΝΠΣNPS,Αλγοριθμικά Θέματα Δικτύων,Algorithmika THemata Diktywn",
			},
			{
				name: "Σχεδίαση Κυκλωμάτων με Η/Υ",
				key: "sxediashKyklwmatwnMeHY",
				searchStr: "ΝΠΣNPS,Σχεδίαση Κυκλωμάτων με Η/Υ,Sxediash Kyklwmatwn me H/Y",
			},
			{
			...
			},
			{
				...
				searchStr: "ΝΠΣNPS,Συστήματα Πραγματικού Χρόνου,Systhmata Pragmatikoy Xronou,sistimata",
			},
			{
				name: "Αλληλεπίδραση Ανθρώπου‐Μηχανής",
				key: "allhlepidrashAnthrwpouMhxanhs",
				searchStr: "ΝΠΣNPS,Αλληλεπίδραση Ανθρώπου-Μηχανής,Allhlepidrash Anthrwpou-Mhxanhs,allilepidrash",
			},
			{
				name: "Ανάλυση Απαιτήσεων/Έλεγχος Λογισμικού",
				key: "analyshApaithsewnElenxosLogismikoy",
				searchStr: "ΝΠΣNPS,Ανάλυση Απαιτήσεων Διασφάλιση Ποιότητας και Έλεγχος Λογισμικού,Analysh Apaithsewn Elenxos Logismikoy,analish",
			},
			{
		...
		courses: [
			{
				...
				searchStr: "ΠΠΣPPS,Σχεδίαση Δικτύων Υπολογιστών,Sxediash Diktywn Ypologistwn",
			},
			{
				name: "Ηλεκτρονικό Εμπόριο",
				key: "HlektronikoEmporio",
				searchStr: "ΠΠΣPPS,Ηλεκτρονικό Εμπόριο & Τεχνολογίες Διαδικτύου,Hlektroniko Emporio & Texnologies Diadiktyou",
			},
			{
				name: "Ψηφιακή Επεξεργασία Εικόνας",
				key: "PsifiakhEpeksergasiaEikonas",
				searchStr: "ΠΠΣPPS,Ψηφιακή Επεξεργασία Εικόνας,Pshfiakh,Psifiakh Epeksergasia Eikonas",
			},
			{
				name: "Ειδικά Θέματα Κατανεμημένων",
				key: "EidikaThemataKatanemhmenwnSysthmatwn",
				searchStr: "ΠΠΣPPS,Ειδικά Θέματα Κατανεμημένων Συστημάτων,Eidika Themata Katanemhmenwn Systhmatwn",
			},
			{
				name: "Πληροφοριακά Συστήματα Διοικησης",
				key: "PliroforiakaSysthmataDioikhshs",
				searchStr: "ΠΠΣPPS,Πληροφοριακά Συστήματα Διοικησης,Pliroforiaka Systhmata Dioikhshs",
			},
			{
				name: "Πληροφορική στην Εκπαίδευση",
				key: "PliroforikhSthnEkpaidefsh",
				searchStr: "ΠΠΣPPS,Πληροφορική στην Εκπαίδευση,Pliroforikh sthn Ekpaidefsh",
			},
			{
				name: "Ενσωματωμένα Συστήματα",
				key: "enswmatwmenaSysthmata",
				searchStr: "ΝΠΣNPS,Ενσωματωμένα Συστήματα,Enswmatwmena Systhmata,ensomatomena sistimata",
			},
			{
				name: "Κινητά και Δορυφορικά Δίκτυα",
				key: "kinhtaDoryforikaDiktya",
				searchStr: "ΝΠΣNPS,Κινητά και Δορυφορικά Δίκτυα,Kinhta kai Doryforika Diktya,diktua",
			},
			{
				name: "Ευρυζωνικά Δίκτυα",
				key: "evryzwnikaDiktya",
				searchStr: "ΝΠΣNPS,Ευρυζωνικά Δίκτυα,Evryzwnika Diktya,eurizonika diktua",
			},
			{
				name: "Ανάπτυξη Συστημάτων Αισθητήρων",
				key: "anaptykshSysthmatwnAisthhthrwn",
				searchStr: "ΝΠΣNPS,Ανάπτυξη Συστημάτων Αισθητήρων,Anaptyksh Systhmatwn Aisthhthrwn",
			},
			{
				name: "Βιομηχανική Πληροφορική",
				key: "viomhxanikhPlhroforikh",
				searchStr: "ΝΠΣNPS,Βιομηχανική Πληροφορική,Viomhxanikh Plhroforikh,Biomixaniki",
			},
			{
				name: "Εισαγωγή στη Ρομποτική",
				key: "eisagwghSthRompotikh",
				searchStr: "ΝΠΣNPS,Εισαγωγή στη Ρομποτική,Eisagwgh sth Rompotikh,isagogi,robotiki",
			},
			{
				name: "Προχωρημένα θέματα Προγρ σε Συμβ Γλώσσα",
				key: "proxwrhmenaThemataprogrSeSymvGlwssa",
				searchStr: "ΝΠΣNPS,Προχωρημένα θέματα Προγραμματισμού σε Συμβολική Γλώσσα,Proxwrhmena themata Programmatismoy se Symvolikh Glwssa",
			},
			{
				name: "Διαχείριση Έργων Λογισμικού",
				key: "diaxeirishErgwnLogismikoy",
				searchStr: "ΝΠΣNPS,Διαχείριση Έργων Λογισμικού,Diaxeirish Ergwn Logismikoy",
			},
			{
			...
			},
			{
				...
				searchStr: "ΝΠΣNPS,Εξόρυξη Γνώσης από Δεδομένα ή Γραφικά,Eksoryksh Gnwshs apo Dedomena h Grafika",
			}
		]
	}
];
...
function insertToDB(){
	full.forEach(function(semester){
		semestersCollection.insert(semester)
		.then((docs)=>{
